...
class SDLCSession:
    ...
    def __init__(
        ...
        # NEW: Phase workflow support
        self.metadata: Dict[str, Any] = {
            "phase_history": [],
            "current_phase": None,
            "iteration_count": 0,
            "workflow_mode": "sequential"  # or "phase_based"
        }
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "metadata": self.metadata  # NEW: Include phase metadata
        }
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'SDLCSession':
        ...
        # NEW: Load phase metadata (backward compatible)
