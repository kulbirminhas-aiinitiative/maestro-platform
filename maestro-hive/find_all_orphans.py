...
def main():
    ...
    # JQL to find ALL orphan tickets (excluding Epics)
    jql = f'project = {c.project_key} AND parent is EMPTY AND issuetype != Epic'
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            logger.info(f"Found {len(issues)} total orphan tickets.")
            for issue in issues:
