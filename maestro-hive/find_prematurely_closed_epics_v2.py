...
def main():
    ...
    # 1. Find all Done EPICs - Explicitly check MD-2148 first
    logger.info("Searching for Done EPICs...")
    # Broader search: status = Done OR statusCategory = Done
    jql_epics = f'project = {client.config.project_key} AND issuetype = Epic AND status = Done'
