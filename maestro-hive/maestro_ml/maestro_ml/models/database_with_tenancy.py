...
class ArtifactUsage(Base):
    ...
    # ADDED: Multi-tenancy field (denormalized for performance)
    tenant_id = Column(UUID(as_uuid=True), ForeignKey("tenants.id"), nullable=False, index=True)
...
class ProjectCreate(BaseModel):
    ...
    """
    tenant_id: Union[str, PyUUID]  # ADDED: Required for multi-tenancy
    name: str
    problem_class: str
...
class ProjectResponse(BaseModel):
    ...
    """
    id: Union[str, PyUUID]
    tenant_id: Union[str, PyUUID]  # ADDED
    name: str
    problem_class: str
    ...
    def serialize_uuid(self, value: Union[str, PyUUID], _info) -> str:
        return str(value)
...
class ArtifactResponse(BaseModel):
    ...
    tags: List[str]
    is_active: bool
    storage_path: Optional[str] = None  # ADDED for backwards compatibility
