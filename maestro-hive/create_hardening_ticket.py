...
# --- CONFIGURATION ---
PROJECT_KEY = "MD"
TICKET_SUMMARY = "Harden Dev Environment"
...
def main():
    ...
    if existing_issues:
        ...
        description = (
            "Investigate and fix the restart/failure loops in the Dev environment. "
            "Ensure the environment is stable and resilient to failures, similar to the requirements for the Demo environment. "
            "Reference related Auto-Heal tickets (MD-3049 to MD-3056) for context."
        )
