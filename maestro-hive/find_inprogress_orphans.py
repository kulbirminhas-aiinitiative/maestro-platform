...
def main():
    ...
    # JQL to find In Progress tickets without a parent
    jql = f'project = {c.project_key} AND statusCategory = "In Progress" AND parent is EMPTY AND issuetype != Epic'
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            logger.info(f"Found {len(issues)} In Progress orphan tickets.")
            for issue in issues:
