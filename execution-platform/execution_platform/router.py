...
from execution_platform.spi import LLMClient
...
CAP_PATH = os.path.join(os.path.dirname(__file__), "..", "docs", "capabilities.yaml")
POLICY_PATH = os.path.join(os.path.dirname(__file__), "..", "docs", "persona_policy.yaml")
